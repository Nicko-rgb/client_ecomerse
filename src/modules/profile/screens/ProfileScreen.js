...
import { View, Text, ScrollView, StyleSheet, Alert, RefreshControl, TouchableOpacity, ActivityIndicator } from 'react-native';
...
const ProfileScreen = ({ navigation }) => {
    ...
    const { profile, addresses, paymentMethods, loading, error, refreshProfile } = useProfile();
